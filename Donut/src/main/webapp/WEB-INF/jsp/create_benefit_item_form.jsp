...
<body>
	...
	<!-- Start of Create Benefit Section 
	============================================= -->
		...
		<div class="container">
			<div class="contact-comment-form pb50 clearfix">
				<div class="comment-form">
					<form action="createBenefitItem.do" method="POST">
						...
						<div class="contact-comment-info col-xs-12 col-sm-6 col-md-6">
							<input name="benefitAlbumQuantity" type="text" placeholder="Album Quantity...">
						</div>
						<div class="contact-comment-info mt25">
							<textarea name="benefitContent" placeholder="Message Here..." rows="7" cols="30"></textarea>
						</div>
