...
<body>
	...
	<!-- Start of Update Benefit Section 
	============================================= -->
		...
		<div class="container">
			<div class="contact-comment-form pb50 clearfix">
				<div class="comment-form">
					<form action="updateBenefitItem.do" method="POST">
						...
						<div class="contact-comment-info col-xs-12 col-sm-6 col-md-6">
							<input name="benefitDate" type="hidden" value="${benefit.benefitDate}">
						</div>
						<div class="contact-comment-info col-xs-12 col-sm-6 col-md-6">
							<input name="benefitMatchingState" type="hidden" value="${benefit.benefitMatchingState}">
						</div>
						<div class="contact-comment-info col-xs-12 col-sm-6 col-md-6">
						...
						<div class="contact-comment-info col-xs-12 col-sm-6 col-md-6">
							<input name="benefitAlbumQuantity" type="number" value="${benefit.benefitAlbumQuantity}">
						</div>
						<div class="contact-comment-info mt25">
							<textarea name="benefitContent" rows="7" cols="30">${benefit.benefitContent}</textarea>
						</div>
