						...
						<div class="col-sm-12">
										...
										<div class="col-sm-8">
											<div class="blog-text">
												...
												<div class="blog-head-title pt15">
													<h2 class="black"><a href="review_item.html">Stop Running on Hard Surf and Become a Trail Runner</a></h2>
												</div>
												...
												<div class="blog-button text-uppercase">
													<a href="review_item.html">read more <span class="arrow-right-btn ti-arrow-right"></span></a>
												</div>
											</div>
											<!-- /blog-text -->
										</div>
							...
							<div class="blog-pic-text mb40">
								<div class="row">
									<div class="col-sm-4">
										<div class="blog-img">
											<img src="resources/assets/img/blog-pic-4.jpg" alt="image">
										</div>
									</div>
									<!-- /col-md-6 -->
									<div class="col-sm-8">
								...
								<div class="row section-btn">
									<div class="col-sm-offset-8 col-sm-4">
										<div class="home-donate donate-btn-1 text-uppercase">
											<a href="review_create.html">Create</a>
										</div>
									</div>
								</div>
							</div>
